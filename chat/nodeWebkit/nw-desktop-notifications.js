(function(){
	...
	function slideInNotificationWindow(){
		...
		win.moveTo(getXPositionOfNotificationWindow(win),getYPositionOfNotificationWindow(win));
		win.show();
	...
	function getYPositionOfNotificationWindow(win){
		return screen.availTop + screen.availHeight - (WINDOW_HEIGHT+10);
	}
